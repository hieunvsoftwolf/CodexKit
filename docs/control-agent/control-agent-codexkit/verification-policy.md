...
4. `plans/20260406-0515-release-ready-parity-proof/reports/control-state-release-ready-parity-proof-ready-for-planner-20260406-051537.md`
...
If a durable control-state report exists under `plans/20260406-0515-release-ready-parity-proof/reports`, read it after the plan and before routing new sessions.
...
- persist a concise `control-state` snapshot under `plans/20260406-0515-release-ready-parity-proof/reports` before emitting new runnable downstream prompts when that path is in scope
...
- detected current phase: `Phase 1: Current-Head Release-Ready Parity Proof`
- phase state: `ready_for_planner`
- pinned `BASE_SHA`: `308867621e6c3d77746302b08a624445f7b84213`
- latest durable control-state: `plans/20260406-0515-release-ready-parity-proof/reports/control-state-release-ready-parity-proof-ready-for-planner-20260406-051537.md`
- routing note: start with planner-first decomposition before any implementation or independent verification wave because the claim spans release gating, NFR evidence, and packaged-artifact scope on current `main`
